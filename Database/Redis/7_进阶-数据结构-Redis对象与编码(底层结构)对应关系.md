...
在对对象机制详解 和 底层数据结构 有了初步认识之后，我们便可以继续理解它们是怎么对应的：

![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-object-2-4.jpg)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-4.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-21.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-22.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-23.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-9.png)

当使用 hashtable 编码时，上面命令存储如下：

![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-10.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-24.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-11.png)

```bash
SADD Dfruits "apple" "banana" "cherry"
```

![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-12.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-25.png)

然后是编码为SKIPLIST时, 有序集合的内存布局如下:

![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-ds-x-26.png)
...
![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-13.png)

![img](/Database/Redis/images/进阶-数据结构-Redis对象与编码(底层结构)对应关系/db-redis-x-object-14.png)
