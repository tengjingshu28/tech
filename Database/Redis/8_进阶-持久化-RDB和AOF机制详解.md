...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-rdb-1.png)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-42.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-rdb-2.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-41.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-4.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-1.jpg)
...
而在bgrewriteaof子进程完成，日志文件的重写操作后，会提示主线程已经完成重写操作，主线程会将AOF重写缓冲中的命令追加到新的日志文件后面。这时候在高并发的情况下，AOF重写缓冲区积累可能会很大，这样就会造成阻塞，Redis后来通过Linux管道技术让aof重写期间就能同时进行回放，这样aof重写结束后只需回放少量剩余的数据即可。
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-2.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-3.png)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-rdb-4.jpg)
...
![img](/Database/Redis/images/进阶-持久化-RDB和AOF机制详解/redis-x-aof-5.png)
