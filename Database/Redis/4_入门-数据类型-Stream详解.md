...
![img](/Database/Redis/images/入门-数据类型-Stream详解/db-redis-stream-1.png)
...
![img](/Database/Redis/images/入门-数据类型-Stream详解/db-redis-stream-2.jpeg)
...
![img](/Database/Redis/images/入门-数据类型-Stream详解/db-redis-stream-3.png)
...
![img](/Database/Redis/images/入门-数据类型-Stream详解/db-redis-stream-4.png)

客户端可以平滑扩展，提高处理能力

![img](/Database/Redis/images/入门-数据类型-Stream详解/db-redis-stream-5.png)
