...
![img](images/Java_内存模型引入/java-memory-model-1.png)
...
![img](images/Java_内存模型引入/java-memory-model-2.png)
...
![img](images/Java_内存模型引入/java-memory-model-3.png)
...
![img](images/Java_内存模型引入/java-memory-model-4.png)
...
![img](images/Java_内存模型引入/java-memory-model-5.png)
...
![img](images/Java_内存模型引入/java-memory-model-6.png)
...
![img](images/Java_内存模型引入/java-memory-model-7.png)
