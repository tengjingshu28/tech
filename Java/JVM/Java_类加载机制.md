...
![img](images/Java_类加载机制/java_jvm_classload_2.png)
...
![img](images/Java_类加载机制/java_jvm_classload_1.png)
...
![img](images/Java_类加载机制/java_jvm_classload_3.png)
...
public class MyClassLoader extends ClassLoader {
    ...
    public static void main(String[] args)  {
        ...
        try {
            testClass = classLoader.loadClass("com.jvm.classloader.Test2");
