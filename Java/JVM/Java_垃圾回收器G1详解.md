...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-1.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-2.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-3.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-4.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-5.png)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-5-1.gif)

#### 2.4.4 漏标问题

在remark过程中，黑色指向了白色，如果不对黑色重新扫描，则会漏标。会把白色D对象当作没有新引用指向从而回收掉。

![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-6.png)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-7.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-8.jpeg)
...
![img](images/Java_垃圾回收器G1详解/java-jvm-gc-g1-9.png)
