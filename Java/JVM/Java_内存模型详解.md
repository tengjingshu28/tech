...
![img](images/Java_内存模型详解/java-jmm-1.png)
...
![img](images/Java_内存模型详解/java-jmm-2.png)
...
![img](images/Java_内存模型详解/java-jmm-3.png)
...
![img](images/Java_内存模型详解/java-jmm-4.png)
...
![img](images/Java_内存模型详解/java-jmm-5.png)
...
![img](images/Java_内存模型详解/java-jmm-6.png)

如上图所示，A 和 C 之间存在数据依赖关系，同时 B 和 C 之间也存在数据依赖关系。因此在最终执行的指令序列中，C 不能被重排序到 A 和 B 的前面（C 排到 A 和 B 的前面，程序的结果将会被改变）。但 A 和 B 之间没有数据依赖关系，编译器和处理器可以重排序 A 和 B 之间的执行顺序。下图是该程序的两种执行顺序：

![img](images/Java_内存模型详解/java-jmm-7.png)
...
![img](images/Java_内存模型详解/java-jmm-8.png)
...
![img](images/Java_内存模型详解/java-jmm-9.png)
...
![img](images/Java_内存模型详解/java-jmm-10.png)
...
![img](images/Java_内存模型详解/java-jmm-11.png)

现在我们再假设这两个线程没有做同步，下面是这个未同步程序在顺序一致性模型中的执行示意图：

![img](images/Java_内存模型详解/java-jmm-12.png)
...
![img](images/Java_内存模型详解/java-jmm-13.png)
...
![img](images/Java_内存模型详解/java-jmm-14.png)
...
![img](images/Java_内存模型详解/java-jmm-15.png)
...
![img](images/Java_内存模型详解/java-jmm-x01.png)
...
![img](images/Java_内存模型详解/java-jmm-x02.png)
...
![img](images/Java_内存模型详解/java-jmm-x03.png)
...
![img](images/Java_内存模型详解/java-jmm-x04.png)
